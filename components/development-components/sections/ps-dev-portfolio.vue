<template>
  <ps-section>
    <ps-second-heading>Portfolio Site</ps-second-heading>

    <ps-album
      :images="portfolioAlbumImages"
...
import portfolioAlbumImages from '~/constants/album-images/development-albums/portfolio-album-images'
